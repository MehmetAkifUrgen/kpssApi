...
SEASON_URL = "https://en.wikipedia.org/wiki/2025%E2%80%9326_2._Bundesliga"

def get_bundesliga2_teams():
...
def main():
    ...
    for name in teams:
        ...
        time.sleep(0.5)
    # football.json'da teams altında 2. Bundesliga olarak ekle
    with open("../football.json", "r+", encoding="utf-8") as f:
        data = json.load(f)
        if "teams" not in data:
            data["teams"] = {}
        data["teams"]["2. Bundesliga"] = teams_with_logos
        f.seek(0)
